...
const DEFAULT_HOST = "fluxlinks.ml";
const DEFAULT_BASE = "https://fluxlinks.ml/";
...
<title>FluxLinks URL Shortner</title>
...
const htmlend = `
<footer><hr>
<subtitle style="font-size:0.8rem;color:white">More Services <a href="${DEFAULT_BASE}">fluxlinks.ml</a> | <a href="https://fluxlinks.ml">fluxlinks.ml</a> | <a href="https://fluxlinks.ml">fluxlinks.ml</a>
<br>
</subtitle>
<subtitle style="font-size:0.8rem;color:white">FluxDevelopment <a href="${DEFAULT_BASE}">Home</a> | <a href="https://dsc.gg/fluxdevelopment">Discord</a> | <a href="https://youtube.com/@fluxdevelopment">Youtube</a>
</subtitle></footer>
</div>
...
<option value="https://fluxlinks.ml" selected>https://fluxlinks.ml/</option>
<option value="https://fluxlinks.ml" disabled>https://fluxlinks.ml</option>
<option value="https://fluxlinks.ml" disabled>https://fluxlinks.ml</option>
<option value="https://fluxlinks.ml" disabled>https://fluxlinks.ml</option>
...
app.get("/db/clear", async (req, res) => {
  ...
  if (!(username === process.env.username || "fluxxyboi" && password === process.env.password || "anshislegend")) {
